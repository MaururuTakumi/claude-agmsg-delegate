...
delegate_claude.py --versionが0.2.0であることを確認してください。
...
version `0.2.0`のruntime contractは`contract_version=2`です。Fable／Sonnetの
...
期待値は`0.2.0`で、dry-runには`contract_version: 2`が出ます。実jobがfileを
